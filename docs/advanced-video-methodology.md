...
本项目的后半段不再把视频理解成“背景图 + 字幕 + 标题栏”，而是采用“口播语义驱动的视频视觉系统”：
...
- `evidence`：新闻截图、官网公告、推文、财报、监管文件。必须有红框、箭头、下划线或局部放大。
...
- `concept`：AI 大脑、数据网络、未来城市等抽象科技画面，不能连续超过 12 秒。
...
- 氛围素材：真实 b-roll 或风格统一的概念画面。

正式视频应混合使用官方截图、产品 UI、真实场景、概念画面、Remotion 图解和关键词观点卡。
...
- 任何 10 秒内都要有至少一次信息变化。
- 同一素材不得在同一视频中重复使用，除非做了裁切、放大或二次标注。
